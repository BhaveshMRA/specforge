...
Type a plain-English product idea. Get back:
...
- **Animate view** — step-by-step walkthrough of the system's message journey, with visual micro-animations per step (animated particle traveling between icon nodes), manual Next/Finish navigation, and a domain-specific sample query generated by the model
